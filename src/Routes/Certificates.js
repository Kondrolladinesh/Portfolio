    ...
    <div>
      ...
      <Container>
        <CustomCarousel autoPlay axis="horizontal" infiniteLoop >
            <div>
                <CustomImg src="./Fundamentals_Of_Network_Communication.png" alt="Fundamentals_Of_Network_Communication" />
                <p className="legend">Fundamentals Of Network Communication</p>
            </div>
            <div>
                <CustomImg src="./Local_Area_Networks_(CNDS).png" alt="Local_Area_Networks_(CNDS)" />
                <p className="legend">Local Area Networks</p>
            </div>
            <div>
                <CustomImg src="./Packet_Switching_Networks_and_Algorithms.png" alt="Packet_Switching_Networks_and_Algorithms" />
                <p className="legend">Packet Switching Networks and Algorithms</p>
            </div>
            <div>
                <CustomImg src="./Computer_Networks_Total_Courses.png" alt="Computer_Networks_Total_Courses" />
                <p className="legend">Computer Networks Total Courses</p>
            </div>
            <div>
                <CustomImg src="./AppWithKotlin.png" alt="C_certificate" />
                <p className="legend">Android App with Kotlin</p>
            </div>
            <div>
                <CustomImg src="./C_Certificate.png" alt="C_certificate" />
                <p className="legend">C programming for Everyone</p>
            </div>
            <div>
                <CustomImg src="./java_for_android.png" alt='java_for_android_certificate' />
      ...
      <AcademicContainer>
        ...
        <Container>
          <CustomCarousel autoPlay axis="horizontal" infiniteLoop >
              <div>
                  <CustomImg src="./Google_Cloud_Career_Readiness.png" alt="Google_Cloud_Career_Readiness" />
